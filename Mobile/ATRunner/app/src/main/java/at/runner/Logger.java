...
/**
 * A logging class that will log information to a log file.
 */
public class Logger {
    ...
    private void cleanUpLogs() {
        String functionName = "Logger_cleanUpLogs()";
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                String dateString = StringUtils.formatCalendarInstanceShortDate(c) + ".log";
    ...
    private void write(String severity, String category, String message) {
        try {
            ...
            String dateString = StringUtils.formatCalendarInstanceShortDate(c);
            ...
            try {
                ...
                writer.append(String.format("%d-%02d-%02d %02d:%02d:%02d %s%s%s", year, month, day, hour, minute, second, StringUtils.rightPad(severity, 10), StringUtils.rightPad(category, 50), message));
                writer.flush();
            } finally {
                writer.close();
            }
